...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(
			...
			function list() {
				$.ajax({
                    url : '/rest-poc-server/resources/resources/product/list',
			...
			function() {
                ...
                $("#find-product-by-description-term").onChange(function () {
                    $.ajax({
                        url : '/rest-poc-server/resources/product/find/by/description/' + $("#find-product-by-description-term").val(),
                        success : function(data) {
                            $("#list-response").html(data);
                        }
                    });
            ...
            function() {
                ...
                $("#add-product-button").onClick(function() {
                    $.ajax({
                    	type : 'PUT',
                        url : '/rest-poc-server/resources/product/add?name=' + name + '&description=' + description,
                        success : function(data) {
            ...
            function() {
                ...
                $("#update-product-button").onClick(function() {
                    $.ajax({
                        type : 'POST',
                        url : '/rest-poc-server/resources/product/update/id/' + id + '?name=' + name + '&description=' + description,
                        success : function(data) {
            ...
            function() {
                ...
                $("#delete-product-button").onClick(function() {
                    $.ajax({
                        url : '/rest-poc-server/resources/product/delete/id/' + id,
                        success : function(data) {
